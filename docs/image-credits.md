# Créditos das imagens dos artigos

Todas as obras abaixo estão em **domínio público** (pinturas/ícones anteriores a 1900),
obtidas via Wikimedia Commons e otimizadas (largura máx. 1000px, JPEG q82).
Arquivos em `assets/articles/`.

| Artigo | Arquivo | Obra | Autor / origem |
|--------|---------|------|----------------|
| 1 — A Existência de Deus (Cosmológico) | `1-deus-existe.jpg` | A Criação de Adão (Capela Sistina, 1512) | Michelangelo |
| 11 — Quem Criou Deus? | `11-quem-criou-deus.jpg` | A Criação do Sol e da Lua (Capela Sistina, 1512) | Michelangelo |
| 5 — A Ressurreição de Jesus | `5-ressurreicao.jpg` | A Ceia em Emaús (1601) | Caravaggio |
| 35 — Jesus Existiu? | `35-jesus-existiu.jpg` | Cristo diante de Pilatos (1881) | Mihály Munkácsy |
| 7 — A Eucaristia | `7-eucaristia.jpg` | A Última Ceia (1495–1498) | Leonardo da Vinci |
| 4 — Maria: Intercessora | `4-maria.jpg` | As Bodas de Caná (1563) | Paolo Veronese |
| 2 — Por que Ser Católico | `2-por-que-catolico.jpg` | A Entrega das Chaves a São Pedro (1481–1482) | Pietro Perugino |
| 23 — Purgatório | `23-purgatorio.jpg` | Um Anjo Liberta as Almas do Purgatório (c. 1610) | Ludovico Carracci |
