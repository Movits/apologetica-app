...
export const STRINGS = {
  pt: {
    ...
    // === Fase 5: rótulos que as telas montavam inline (isEn ? ... : ...) ===
    'common.stepOf': 'Passo {{n}} de {{total}}',
    'common.stopOf': 'Parada {{n}} de {{total}}',
    'common.verse': 'Versículo',
    'auth.needEmail': 'Informe seu e-mail.',
    'liturgy.loading': 'Carregando liturgia',
    'liturgy.entrance': 'Antífona de entrada',
    'liturgy.collect': 'Oração da coleta',
    'liturgy.firstReading': 'Primeira Leitura',
    'liturgy.psalm': 'Salmo Responsorial',
    'liturgy.secondReading': 'Segunda Leitura',
    'liturgy.gospel': 'Evangelho',
    'liturgy.offerings': 'Oração sobre as oferendas',
    'liturgy.communionAntiphon': 'Antífona de comunhão',
    'liturgy.afterCommunion': 'Oração após a comunhão',
    'liturgy.color': 'Cor litúrgica',
    'liturgy.stale': 'Mostrando dados salvos. Sem conexão?',
    'liturgy.footer': 'Liturgia fornecida pela CNBB. Última atualização',
    'liturgy.offlineTitle': 'A liturgia precisa de internet',
    'liturgy.offlineMessage': 'As leituras do dia vêm da CNBB online e ainda não estão guardadas neste aparelho. Conecte e tente de novo.',
    'liturgy.loadError': 'Erro ao carregar a liturgia',
  },
  ...
  en: {
    ...
    // === Phase 5: labels the screens used to build inline (isEn ? ... : ...) ===
    'common.stepOf': 'Step {{n}} of {{total}}',
    'common.stopOf': 'Stop {{n}} of {{total}}',
    'common.verse': 'Verse',
    'auth.needEmail': 'Please enter your email.',
    'liturgy.loading': 'Loading liturgy',
    'liturgy.entrance': 'Entrance Antiphon',
    'liturgy.collect': 'Collect',
    'liturgy.firstReading': 'First Reading',
    'liturgy.psalm': 'Responsorial Psalm',
    'liturgy.secondReading': 'Second Reading',
    'liturgy.gospel': 'Gospel',
    'liturgy.offerings': 'Prayer over the Offerings',
    'liturgy.communionAntiphon': 'Communion Antiphon',
    'liturgy.afterCommunion': 'Prayer After Communion',
    'liturgy.color': 'Liturgical color',
    'liturgy.stale': 'Showing saved data. No connection?',
    'liturgy.footer': 'Liturgy provided by CNBB (in Portuguese). Last update',
    'liturgy.offlineTitle': 'Liturgy needs internet',
    'liturgy.offlineMessage': 'The daily readings come from the CNBB online and are not yet saved on this device. Connect and try again.',
    'liturgy.loadError': 'Error loading liturgy',
  },
};
