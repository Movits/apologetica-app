...
import { Group, Row, ProgressBar } from './ui';

// "Continue lendo" no topo da lista de livros da Bíblia (Onda 6): um Group com
// uma Row (ícone de livro, "Continuar em João 3", progresso em texto) e a
// ProgressBar do capítulo por baixo do texto. Só aparece quando existe uma
// posição salva (ver src/utils/bibleProgress.js) e nunca sequestra a
// navegação: a retomada é sempre um toque. Um ContinueRow único, partilhado
// com a Início, vem na Onda 9.
  ...
  return (
    <Group style={style}>
      ...
      >
        <ProgressBar
          value={ratio}
          accessibilityLabel={t('bible.chapterPct', { pct })}
