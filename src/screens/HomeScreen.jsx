...
const makeStyles = (c, fs) =>
  StyleSheet.create({
    ...
    heroIcon: { fontSize: fs(36), color: c.accent },
    heroTitle: { color: '#fff', fontSize: fs(24), fontWeight: 'bold', marginTop: 8 },
    heroSub: {
      color: c.heroSub,
      fontSize: fs(13),
      textAlign: 'center',
    ...
    heroRef: { color: c.accent, fontSize: fs(12), marginTop: 10, fontStyle: 'italic', fontWeight: 'bold' },
    searchBar: {
      flexDirection: 'row', alignItems: 'center', gap: 10,
      backgroundColor: c.card, borderRadius: 10, paddingHorizontal: 14, paddingVertical: 14,
      marginBottom: 14,
    },
