...
const modalStyles = (c, fs) =>
  StyleSheet.create({
    ...
    place: { fontSize: fs(13), color: c.accentText, fontWeight: 'bold', marginBottom: 4 },
...
const makeStyles = (c, fs) =>
  StyleSheet.create({
    ...
    placeName: { fontSize: fs(12), color: c.accentText, fontWeight: 'bold' },
    ...
    refLink: { color: c.accentText, fontWeight: 'bold', fontStyle: 'normal' },
